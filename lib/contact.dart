...
///     `FlutterContacts.sonar-config.properties.includeNotesOnIos13AndAbove = true` to include
...
class Contact {
  ...
  /// ```dart
  /// FlutterContacts.sonar-config.properties.vCardVersion = VCardVersion.v4;
  /// ```
  ///
